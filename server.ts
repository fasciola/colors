...
if (apiKey && apiKey !== "MY_GEMINI_API_KEY") {
  ...
  console.log("Running in basic harmony mode (no valid GEMINI_API_KEY detected).");
}
...
app.post("/api/generate-palette", async (req, res) => {
  ...
  try {
    ...
    return res.json({
      ...
      praise: "We initialized a calculated visual fallback hierarchy safely. If you configured an API key, check your credentials under Secrets."
    });
  }
});
